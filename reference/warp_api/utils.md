...
Source: https://nvidia.github.io/warp/stable/api_reference/warp_utils.html (Warp 1.16.0)
...
- `array_inner(a, b)` — inner product of two arrays; since 1.16 capturable and replayable in a CUDA
  graph on both CPU and CUDA (experimental).
...
- `array_sum(...)` — sum of array elements; same 1.16 graph-capture support as `array_inner`.
