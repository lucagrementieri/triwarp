...
def query_bvh_nearest(
    ...
    *,
    ...
    [`bvh_from_points`][triwarp.neighbors.bvh_from_points]. Each query
    ...
    min_points_bound, max_points_bound = tw.bounds.aabb_bounds(points)
    min_queries_bound, max_queries_bound = tw.bounds.aabb_bounds(queries)
    min_bound = wp.vec3(
...
def query_hashgrid_nearest(
    ...
    *,
    ...
    Same semantics as [`query_bvh_nearest`][triwarp.neighbors.query_bvh_nearest]. Broad-phase uses
